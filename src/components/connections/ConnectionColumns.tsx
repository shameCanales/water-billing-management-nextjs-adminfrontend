...
import { ActionMenu, ActionMenuItem } from "@/components/ActionMenu"; // Importing your reusable component
...
export const getConnectionColumns = (
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      const { firstName, middleName, lastName, email } = row.original.consumer;
      return (
        <div className="flex flex-col">
